 ...
 */
public class RangeDisplayVariable extends DisplayVariable
{
    ...
    public RangeDisplayVariable(DiagramEngine diagramEngine, double initialValue, double minValue, double maxValue, String label)
    {
