...
public class T
{
    ...
    public double xInv(double xp)
    {
        return (xp - translate.x) / scale;
    }

    public double t(double t)
    {
	return -(t * scale) + translate.t;
    }

    public double tInv(double tp)
    {
    ...
    public void setRelZoom(double zoom, Coordinate pix)
    {
        if (zoom == 0) return;
    ...
    public void beginDrag(Coordinate pix)
    {
	dragPoint = pix;
    }

    public void drag(Coordinate pix)
    {
